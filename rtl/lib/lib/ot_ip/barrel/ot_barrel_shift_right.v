//=====================================================================================================
// File   : ot_barrel_shift_right.v
// Author : Anh Tran
//=====================================================================================================
// Description:
//  a barrel shift right structure with combination logic only
//
...
`ifndef __OT_BARREL_SHIFT_RIGHT_V__
`define __OT_BARREL_SHIFT_RIGHT_V__

(* use_dsp = "yes" *) module ot_barrel_shift_right 
    ...
    //================== BODY ========================
    assign shift_lvl[0] = (in_shift_amt[0]) ? {{word_width{1'b0}}, in_data[word_cnt*word_width-1:word_width]} :
                          in_data;

genvar ii;
generate
    for (ii=1; ii<shift_lvl_cnt; ii=ii+1) begin: level_ii
        assign shift_lvl[ii] = (in_shift_amt[ii]) ? {{((1<<ii)*word_width){1'b0}}, shift_lvl[ii-1][word_cnt*word_width-1:(1<<ii)*word_width]} :
                               shift_lvl[ii-1];
    end
endgenerate
...
`endif // __OT_BARREL_SHIFT_RIGHT_V__
