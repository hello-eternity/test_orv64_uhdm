...
proc expand_file_list {file_list_fpath} {
    if {![file isfile $file_list_fpath]} {
        ...
        return "$file_list_fpath:MISSINGF"
    }
    ...
    while {[gets $f line] >= 0} {
        ...
        if {[llength $ls_item] == 1} {
            ...
            if {[file exists $fpath]} {
                ...
                lappend ls_file "$fpath:MISSINGV"
            }

        } elseif {[llength $ls_item] == 2} {
            if {[lindex $ls_item 0] == "-f"} {
                set nested_file_list_fpath [file join $file_list_dpath [lindex $ls_item 1]]
                ...
                set ls_file [concat $ls_file [glob -nocomplain -directory [lindex $ls_item 1] *.sv]]
                set ls_file [concat $ls_file [glob -nocomplain -directory [lindex $ls_item 1] *.v]]
            } else {
