 ...
 this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000064, 0x80c30070); //[9:0] t_rfc_min (>= tRFCab, 280)
 ...
 this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x000000dc, 0x00a40012); //INIT3 mr(MR1 in lp4 SDRAM)  emr(MR2 in lp4 SDRAM)
 ...
 this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000108, 0x04070e0f); //write latency, read latency, rd2wr, wr2rd 
 ...
 if (this->ht->argmap["ddr_train_1d"].length() > 0) {
   if (this->ht->argmap["use_avery"].length() > 0) {
     ...
     this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000190, 0x02898204); //DFI Timing register
   } else {
   ...
   if (this->ht->argmap["use_avery"].length() > 0) {
     ...
     this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000190, 0x028c8204); //DFI Timing register
   }
 }
 ...
 this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x000001b4, 0x00000904); //DFI Timing register
