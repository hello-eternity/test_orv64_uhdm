 ...
 this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000020, 0x00000202); //derate 
 ...
 if (this->ht->argmap["ddr_train_1d"].length() > 0) {
   fprintf(stderr, "Using 1 for selfrf_sw for training\n");
   this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000030, 0x00000020);
 } else {
   fprintf(stderr, "Using 0 for selfrf_sw for skiptrain\n");
 ...
 this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000050, 0x00210000); //[2] per bank refresh
 ...
 this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000064, 0x812400b0); //[9:0] t_rfc_min (>= tRFCab, 280)
 ...
 if (this->ht->argmap["ddr_train_1d"].length() > 0) {
   fprintf(stderr, "Using 11 for skip_dram_init for training\n");
   this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x000000d0, 0xc0010001); //[25:16]INIT5,post_cke. [11:0]INIT3,pre_cke=2ms
 } else {
   fprintf(stderr, "Using 00 for skip_dram_init for skiptrain\n");
 ...
 this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x000000dc, 0x00c40024); //INIT3 mr(MR1 in lp4 SDRAM)  emr(MR2 in lp4 SDRAM)
 ...
 this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000108, 0x060c0f11); //write latency, read latency, rd2wr, wr2rd 
 ...
 if (this->ht->argmap["ddr_train_1d"].length() > 0) {
   if (this->ht->argmap["use_avery"].length() > 0) {
     fprintf(stderr, "Using DFI timing for AVERY training\n");
     this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000190, 0x02938208); //DFI Timing register
   } else {
     fprintf(stderr, "Using DFI timing for MICRON training\n");
     this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000190, 0x02938208); //DFI Timing register
   }
 } else {
   if (this->ht->argmap["use_avery"].length() > 0) {
     fprintf(stderr, "Using DFI timing for AVERY skiptrain\n");
     this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000190, 0x02948208); //DFI Timing register
   } else {
     fprintf(stderr, "Using DFI timing for MICRON skiptrain\n");
     this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x00000190, 0x02978208); //DFI Timing register
   }
 }
 ...
 this->ht->OURSBUS_WRITE (STATION_DDR_TOP_DDR_UCTRL_ADDR + 4 * 0x000001b4, 0x00000404); //DFI Timing register
