...
void htif_hexwriter_t::read_chunk(addr_t taddr, size_t len, void* vdst, enum rw_target target)
{
  taddr -= base;
...
void htif_hexwriter_t::write_chunk(addr_t taddr, size_t len, const void* vsrc, enum rw_target target)
{
  taddr -= base;
