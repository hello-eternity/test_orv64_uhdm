...
protected:
  ...
  void read_chunk(addr_t taddr, size_t len, void* dst, enum rw_target target = L2);
  void write_chunk(addr_t taddr, size_t len, const void* src, enum rw_target target = L2);
