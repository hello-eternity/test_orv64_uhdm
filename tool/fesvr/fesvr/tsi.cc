...
void tsi_t::read_chunk(addr_t taddr, size_t nbytes, void* dst, enum rw_target target)
{
...
void tsi_t::write_chunk(addr_t taddr, size_t nbytes, const void* src, enum rw_target target)
{
